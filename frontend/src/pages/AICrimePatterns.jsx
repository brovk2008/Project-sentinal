...
export default function AICrimePatterns() {
  ...
  if (loading) return (
    <div className="loading-container">
      ...
      <span style={{ fontSize: 11, letterSpacing: 1, textTransform: 'uppercase' }}>Loading repeat crime pattern model…</span>
    </div>
  )
  ...
  return (
    <div className="ai-layout">
      ...
      <div className="ai-split">
        {/* Main Panel */}
        <div className="ai-main" style={{ flex: 1.3 }}>
          {/* Performance Comparison Chart */}
          <div style={{ padding: '16px 20px 0' }}>
            <div className="panel-header" style={{ padding: '0 0 10px', background: 'transparent', border: 'none' }}>
              <h3 style={{ fontSize: 12 }}>Performance Comparison Across Clusters (Arrests vs Convictions)</h3>
            </div>
            <div style={{ height: 160 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={clusterCards} margin={{ top: 4, right: 10, left: -20, bottom: 0 }}>
                  <XAxis dataKey="label" tick={{ fill: 'var(--text-dim)', fontSize: 8 }} axisLine={false} tickLine={false} />
                  ...
                  <Bar dataKey="avgConvict" name="Avg Conviction Rate" fill="var(--border-focus)" maxBarSize={15} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
